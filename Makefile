...
#    Updated: 2024/09/19 15:43:58 by asideris         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			= debug_utils.c add_token_node.c fake_structs.c  add_command_node.c add_redirection_node.c token.c apply_redirections.c check_access.c #env.c
